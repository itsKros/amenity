    ...
    <div class="sidebar w-4/6 md:w-1/6 absolute top-5 z-10">
        ...
        <div class="list bg-white pt-3 pb-2 md:p-2 pl-4 pr-0 md:py-4  rounded-r-lg select-none" v-if="moreAmenityList">
            <ul class="text-xs relative select-none overflow-y-scroll md:overflow-hidden">
                ...
                <li class="text-xs pb-2 cursor-pointer relative" :class="[isSmartHomePkg == true ? 'text-primary' : '']" @click="hideDetails(), isSmartHomePkg = true">
                    <span>Available Smart Home Packages</span> <i class="fal ml-1" :class="[isSmartHomePkg == true ? 'fa-minus-circle' : 'fa-plus-circle ']"></i>
                </li>
                <li class="text-xs pb-2 cursor-pointer relative" :class="[isFrndFmlyApt == true ? 'text-primary' : '']" @click="hideDetails(), isFrndFmlyApt = true">
                ...
                <li class="text-xs pb-2 cursor-pointer relative" :class="[isDigiPkgLock == true ? 'text-primary' : '']" @click="hideDetails(), isDigiPkgLock = true">
                    <span>Digital Package Lockers</span> <i class="fal ml-1" :class="[isDigiPkgLock == true ? 'fa-minus-circle' : 'fa-plus-circle ']"></i>
                </li>
                <li class="text-xs pb-2 cursor-pointer relative" :class="[isSmartBuildAccess == true ? 'text-primary' : '']" @click="hideDetails(), isSmartBuildAccess = true">
                    <span>Smart Building Access</span> <i class="fal ml-1" :class="[isSmartBuildAccess == true ? 'fa-minus-circle' : 'fa-plus-circle ']"></i>
                </li>
                <li class="text-xs pb-2 cursor-pointer relative" :class="[isEVCharging == true ? 'text-primary' : '']" @click="hideDetails(), isEVCharging = true">
                    <span>EV Charging Stations</span> <i class="fal ml-1" :class="[isEVCharging == true ? 'fa-minus-circle' : 'fa-plus-circle ']"></i>
                </li>
                <li class="text-xs pb-2 cursor-pointer relative" :class="[isSolarArray == true ? 'text-primary' : '']" @click="hideDetails(), isSolarArray = true">
                ...
                <li class="text-xs pb-2 cursor-pointer relative" :class="[isDigiConServ == true ? 'text-primary' : '']" @click="hideDetails(), isDigiConServ = true">
...
.cec{top:8%}.shp {top: 13%;}.ffa {top: 17%;}.dpl {top:25%;}.sba {top:30%;}.evc{top:35%;}.solAr {top:40%;}.dcs {top:54%;}
